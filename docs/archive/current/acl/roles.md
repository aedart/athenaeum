...
See Laravel's [documentation](https://laravel.com/docs/13.x/eloquent#inserting-and-updating-models) for additional information on how to create new records.
