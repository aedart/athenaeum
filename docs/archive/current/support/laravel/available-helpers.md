...
| Trait                                                                        | Defaults to                                                       |
|------------------------------------------------------------------------------|-------------------------------------------------------------------|
| <small>`\Aedart\Support\Helpers\Password\PasswordBrokerManagerTrait`</small> | <small>`\Illuminate\Contracts\Auth\PasswordBrokerFactory`</small> |
| <small>`\Aedart\Support\Helpers\Password\PasswordBrokerTrait`</small>        | <small>`\Illuminate\Contracts\Auth\PasswordBroker`</small>        |
