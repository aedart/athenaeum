...
For instance, you can use Laravel's [Validator](https://laravel.com/docs/13.x/validation#manually-creating-validators) to perform validation of a response's payload.  
