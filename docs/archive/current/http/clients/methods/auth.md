...
Inspired by [Laravel's Http Client](https://laravel.com/docs/13.x/http-client#authentication), authentication headers can be specified via these shortcut methods.
