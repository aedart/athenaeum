...
Similar to [Laravel's native Api Resources](https://laravel.com/docs/13.x/eloquent-resources#conditional-relationships), this package offers a way to include and represent relations (_in a fluent manner_), if they are eager-loaded for the given model. 
...
Imagine that your User model has a defined a [belongs to "Address" relation](https://laravel.com/docs/13.x/eloquent-relationships#one-to-many-inverse).
