...
For requests that are intended to delete or [soft-delete](https://laravel.com/docs/13.x/eloquent#soft-deleting) a resource, you can use the `DeleteSingleResourceRequest` abstraction.
