...
However, if you use the `Dto` abstraction with [Laravel's Service Container](https://laravel.com/docs/13.x/container), populating nested DTOs will be automatically handled for you. 
...
In the above example, the `Address` DTO is automatically resolved and populated by the [Service Container](https://laravel.com/docs/13.x/container).
