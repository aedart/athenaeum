...
You can also resolve your bindings, by using Laravel's `App` [Facade](https://laravel.com/docs/9.x/facades).
...
You should take some time to read about their conceptual [benefits and limitations](https://laravel.com/docs/9.x/facades#when-to-use-facades).  
:::
