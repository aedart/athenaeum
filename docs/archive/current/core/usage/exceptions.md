...
Since Laravel's [Error & Exception Handling](https://laravel.com/docs/13.x/errors#the-exception-handler) mechanism depends on a Http Request and Response, it cannot be used directly with this application. 
...
::: tip
Terminating callbacks can also be registered in your Service Provider's [boot method](https://laravel.com/docs/13.x/providers#the-boot-method).
