...
You can read more about the configuration in Laravel's [documentation](https://laravel.com/docs/13.x/logging).
...
You can also use Laravel's `Log` [Facade](https://laravel.com/docs/13.x/facades). 
