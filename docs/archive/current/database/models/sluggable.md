...
The following local [query scope methods](https://laravel.com/docs/13.x/eloquent#local-scopes) are offered:
...
If your model supports [soft-deleting](https://laravel.com/docs/13.x/eloquent#soft-deleting), and you attempt to find a record by a slug that has been soft deleted, then none of the _"find by slug"_ methods are going to return a match.
