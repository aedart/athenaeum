...
This package offers a way to register [commands](https://laravel.com/docs/13.x/artisan) and [schedules](https://laravel.com/docs/13.x/scheduling) via configuration.
