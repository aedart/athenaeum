...
It is therefore recommended that you evaluate the requested resource inside your [Form Request](https://laravel.com/docs/13.x/validation#form-request-validation).
...
Please read [Laravel's exception handler documentation](https://laravel.com/docs/13.x/errors#the-exception-handler) for additional information.