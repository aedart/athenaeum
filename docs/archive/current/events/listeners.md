...
To register event listeners, state the [Event](https://laravel.com/docs/10.x/events#defining-events) class path or identifier inside the `listeners` key, in your `/config/events.php` file.
