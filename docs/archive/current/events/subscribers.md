...
To register event [Subscribers](https://laravel.com/docs/13.x/events#event-subscribers), state the class path of your subscribers inside the `subscribers` key, in your `/config/events.php` file.
