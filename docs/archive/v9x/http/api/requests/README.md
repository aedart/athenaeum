...
This package also offers a few opinionated [Form Request](https://laravel.com/docs/12.x/validation#form-request-validation) abstractions, intended to be used for APIs.
...
* Complex cross-field validation that [regular validation rules](https://laravel.com/docs/12.x/validation#available-validation-rules) might not be able to satisfy.
