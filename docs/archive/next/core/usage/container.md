...
The Core Application is essentially an extended version of Laravel's [Service Container](https://laravel.com/docs/11.x/container).
...
For more saturated examples and information on how to use the Service Container, please review Laravel's [documentation](https://laravel.com/docs/11.x/container). 
...
You can also resolve your bindings, by using Laravel's `App` [Facade](https://laravel.com/docs/11.x/facades).
...
You should take some time to read about their conceptual [benefits and limitations](https://laravel.com/docs/11.x/facades#when-to-use-facades).  
:::
