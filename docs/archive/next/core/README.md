...
This means that [Blade](https://laravel.com/docs/9.x/blade) isn't directly supported.
...
As such, [Eloquent](https://laravel.com/docs/9.x/eloquent) is not directly support by this application.
