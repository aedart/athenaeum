import{_ as n,p as s,q as a,a1 as e}from"./framework-efe98465.js";const t={},p=e(`<h1 id="implement-dto" tabindex="-1"><a class="header-anchor" href="#implement-dto" aria-hidden="true">#</a> Implement DTO</h1><p>To implement your DTO, extend the <code>Dto</code> abstraction. Also, you should ensure that it implements your previously defined interface.</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>
...
<span class="token keyword">use</span> <span class="token package">Aedart<span class="token punctuation">\\</span>Dto</span><span class="token punctuation">;</span>
