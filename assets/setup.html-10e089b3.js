...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,1);function v(h,m){const n=i("RouterLink");return o(),t("div",null,[p,c("p",null,[e("If you are using the "),r(n,{to:"/archive/current/core/"},{default:d(()=>[e("Athenaeum Core Application")]),_:1}),e(", then run the following command to publish assets:")]),u])}const g=a(l,[["render",v],["__file","setup.html.vue"]]);export{g as default};
